...
def test_auth_user_isnt_owner():
    ...
    resp = requests.post(config.url + 'channel/addowner/v1', json={"token": user2_token, "channel_id": 5444, "u_id": user3_id})
    assert(resp.status_code == ACCESS_ERROR)
    resp2 = requests.post(config.url + 'channel/addowner/v1', json={"token": user3_token, "channel_id": 243, "u_id": user2_id})
    assert(resp2.status_code == ACCESS_ERROR)
...
def test_u_id_is_an_owner(initial_data):
    ...
    resp = requests.post(config.url + 'channel/addowner/v1', json={"token": user2_token, "channel_id": 5444, "u_id": user1_id})
    assert(resp.status_code == ACCESS_ERROR)
